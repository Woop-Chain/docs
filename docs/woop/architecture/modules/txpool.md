...
id: txpool 
title: TxPool
description: Explanation for the TxPool module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
Node operators can query these GRPC endpoints, as described in the **[CLI Commands](/docs/woop/get-started/cli-commands#transaction-pool-commands)** section.
...
![TxPool Error scenario #1](/.gitbook/assets/txpool-error-1.png)
...
![TxPool Error scenario #2](/.gitbook/assets/txpool-error-2.png)

> This happens whenever you get the following error:
> ```shell
> 2021-11-04T15:41:07.665+0100 [ERROR] woopchain.consensus.dev: failed to write transaction: transaction's gas limit exceeds block gas limit
> ```
