...
id: state
title: State
description: Explanation for the state module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
This enables the WoopChain to get a specific Merkle trie, for a specific point in time. <br />
...
*state/executor.go* includes all the information needed for the WoopChain to decide how a block changes the current
