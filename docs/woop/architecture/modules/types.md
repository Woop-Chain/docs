...
id: types 
title: Types
description: Explanation for the types module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
Unlike clients such as GETH, the WoopChain doesn't use reflection for the encoding.<br />
...
By manually defining these methods, the WoopChain doesn't need to use reflection. In *rlp_marshal.go*, you can find
