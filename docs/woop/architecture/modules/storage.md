...
id: storage
title: Storage
description: Explanation for the storage module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
The WoopChain currently utilizes **LevelDB** for data storage, as well as an **in-memory** data store.

Throughout the WoopChain, when modules need to interact with the underlying data store, 
...
In order to make querying the LevelDB storage deterministic, and to avoid key storage clashing, the WoopChain leverages
