...
id: minimal
title: Minimal
description: Explanation for the minimal module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
As mentioned before, WoopChain is a set of different modules, all connected to each other.<br />
...
It acts as a central hub for all the services that run on the WoopChain.
