...
id: json-rpc 
title: JSON RPC
description: Explanation for the JSON RPC module of WoopChain.
keywords:
  - docs
  - woopchain
  - woop
...
The WoopChain uses the ***blockchain interface*** to define all the methods that the JSON RPC module needs to use, in
order to deliver its endpoints.

The blockchain interface is implemented by the **[Minimal](/docs/woop/architecture/modules/minimal)** server. It is the base implementation
