...
description: "How to enable Prometheus metrics for WoopChain."
keywords:
  - docs
  - woopchain
  - woop
...
WoopChain can report and serve the Prometheus metrics, which in their turn can be consumed using Prometheus collector(s).
