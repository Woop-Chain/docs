...
````bash
woop ibft switch --chain ./genesis.json --type PoS --deployment 100 --from 200
````
...
Please check [Proof of Stake](/docs/woop/consensus/pos-concepts) for more details about Staking contract.
...
To find out more about Staking, visit the **[Set up and use Proof of Stake ](/docs/woop/consensus/pos-stake-unstake)**.
:::
