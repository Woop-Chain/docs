...
The JSON-RPC layer of the WoopChain provides developers with the functionality of easily interacting with the blockchain,
...
To start the WoopChain in development mode, which is explained in the [CLI Commands](/docs/woop/get-started/cli-commands) section, 
run the following: 
````bash
