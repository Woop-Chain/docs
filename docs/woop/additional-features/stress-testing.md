...
description: How to perform a stress test using the WoopChain Loadbot.
keywords:
  - docs
  - woopchain
  - woop
...
- You have a working WoopChain network up and running
- Both your JSON-RPC and GRPC endpoints are reachable

## Overview

The WoopChain Loadbot is a helper utility that is meant to stress test a WoopChain network.
...
The contract being deployed can be specified using [specific flags](/docs/woop/get-started/cli-commands#loadbot-flags), or if the contract path is omitted, a default 
...
```bash
woop loadbot  --jsonrpc http://127.0.0.1:10002 --grpc-address 127.0.0.1:10000 --sender 0x9A2E59d06899a383ef47C1Ec265317986D026055 --count 2000 --value 0x100 --tps 100
```
